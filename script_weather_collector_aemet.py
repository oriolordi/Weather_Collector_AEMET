# Weather collector (script version)

# Author: Oriol Ordi

# This script is meant to be run on an ec2 instance, daily, with a crontab command
# and the AWS account should be connected to in that ec2 instance, via AWS cli using aws configure
...
def main():
    ...
    bucket_name = "bucketweatheraemet"
